...
body{
  ...
  background-image: url('https://aliounendbucket.s3.eu-west-3.amazonaws.com/background.jpg'); background-position: center;
...
<div id="container">
  ...
  <p><a href="#">
   <?php
   echo implode('',file('http://169.254.169.254/latest/meta-data/public-ipv4')); 
   ?>
  </a></p>
